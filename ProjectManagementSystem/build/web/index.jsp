...
<head>
    ...
    <title>Hosgeldiniz | Personel/Proje Islemleri Takip Sistemi</title>
            ...
            <div class="content">
                <div class="container">
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card mb-3">
                                <img class="card-img-top" src="assets/img/anasayfa.png" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Henuz aramiza katilmadiysaniz hemen Kaydolun!</h5>
                                    <p class="card-text">Is trafiginizi duzenleyin, takip edin, kontrol edin ve zamandan tasarruf edin!</p>
                                    <p class="card-text"><small class="text-muted">Sizi aramizda gormekten mutluluk duyariz...</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
