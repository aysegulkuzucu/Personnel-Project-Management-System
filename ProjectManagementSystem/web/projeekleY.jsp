                            ...
                            if(request.getMethod().compareToIgnoreCase("post")==0)
                                {
                                    try
                                    {
                                        ...
                                        String projeAciklama = request.getParameter("projeAciklama");
                                         ...
                                         String query = "INSERT INTO proje(kayitNo,projeAdi,projeTuru,projeAciklama) VALUES (?,?,?,?)";
                                        ...
                                        color = "green";
                                        msg = "Yeni Proje Başarıyla Eklendi...";
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2">Yeni Projenin Kayıt Numarası </label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            <label class="col-sm-2">Proje Hakkında Kısa Açıklama  </label>
                                            <div class="col-sm-10">
                                                <input type="text" name="projeAciklama" class="form-control" id="projeAciklama">
                                                <small class="form-text text-muted">Yeni proje hakkinda kisa bir aciklama yaziniz...</small>
                                            </div>
                                        </div>
