...
<html>
                       ...
                       if(request.getMethod().compareToIgnoreCase("post")==0)
                           {
                                try
                                {
                                        ...
                                        String tel = request.getParameter("tel");
                                         ...
                                         String query = "update personel set personelAdi = ?, personelSadi = ?, email= ?, projeAdi =? ,tel= ? where kayitNo = ?";

                                        PreparedStatement pst = con.prepareStatement(query);


                                        pst.setString(1, personelAdi);
                                        pst.setString(2, personelSadi);
                                        pst.setString(3, email);
                                        pst.setString(4, projeAdi);
                                        pst.setString(5, tel);
                                        pst.setString(6, kayitNo);
                                        pst.executeUpdate();
    ...
    <div class="form-group col-12 p-0">
        ...
        <a href="personelgoruntuleY.jsp"><button  class="btn btn-primary mb-2"><i class="fas fa-save"></i> Personelleri Goruntule</button></a>
    </div>
        ...
        <form id="form" method="post" action="personelduzenleY.jsp" class="form-horizontal">
                                ...
                                <% 
                                   ...
                                   pst = con.prepareStatement("select * from personel where kayitNo = ?");
                                   pst.setString(1, id);
                                   rs = pst.executeQuery();
                            ...
                            <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">Kayitli Personelin Uzerinde Degisiklikler Yapin...</div>
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="personelSadi" class="form-control" id="personelSAdi"  value="<%= rs.getString("personelSadi") %>">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="email" class="form-control" id="email" value="<%= rs.getString("email") %>">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="tel" class="form-control" id="tel" value="<%= rs.getString("tel") %>">
