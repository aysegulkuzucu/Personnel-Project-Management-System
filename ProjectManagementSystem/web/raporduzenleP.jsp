...
<html>
    ...
    <div class="form-group col-12 p-0">
        ...
        <a href="anasayfaP.jsp"><button class="btn btn-secondary mb-2"><i class="fas fa-times"></i> Anasayfaya Don</button></a>
        <a href="projeraporlariP.jsp"><button  class="btn btn-primary mb-2"><i class="fas fa-save"></i> Tum Raporlar</button></a>
    </div>
        ...
        <form id="form" method="post" action="raporduzenleP.jsp" class="form-horizontal">
            ...
            %>   
                            ...
                            <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">Daha Once Olusturulmus Projenin Uzerinde Degisiklikler Yapin...</div>
                                <div class="card-body">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <small class="form-text text-muted">Kayitli Proje Raporunun kayit numarasini giriniz..</small>
                                            </div>
                                        </div><!-- comment -->
